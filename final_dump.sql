...
INSERT INTO `lesson` VALUES (1,NULL,1,0,1),(2,NULL,2,0,1),(3,NULL,3,0,1),(4,NULL,4,0,1),(5,NULL,5,0,1),(6,NULL,6,0,1);
...
INSERT INTO `school_year` VALUES (1,'2019-12-15','2019-12-21','2',1);
...
INSERT INTO `students` VALUES (1,'Carlos','juan ','2019-12-31','Buenos Aires ','Bahía Blanca','paraguay 1132','1','female','DNI','12121212','tutor','02216166842','albert thomas','10');
...
INSERT INTO `teachers` VALUES (1,'Lopez','Julio','2019-12-24','Bahía Blanca','calle falsa 123','DNI','434311','123123123');
...
INSERT INTO `users` VALUES ('2019-12-17',NULL,1,0,'superadmin','admin@admin.com',NULL,NULL,1,'pbkdf2:sha256:150000$ywOdrtZw$44465d9903de3a6c1c7f22dbabc6f2521797ff53f0c8c3a8bd74dad654af893d');
...
INSERT INTO `workshop` VALUES (1,'piano','pn',1,1,5,'1','paraguay 1132','paraguay 1132','02:00');
...
CREATE TABLE `workshop_students` (
  ...
  PRIMARY KEY (`workshop_id`,`student_id`,`lesson_id`),
  ...
  CONSTRAINT `workshop_students_ibfk_3` FOREIGN KEY (`lesson_id`) REFERENCES `lesson` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-12-17 22:59:43
